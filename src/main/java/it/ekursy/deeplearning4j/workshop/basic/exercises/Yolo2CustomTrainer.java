...
public class Yolo2CustomTrainer {
    ...
    private static ComputationGraph initCustomModel(ComputationGraph pretrained, INDArray priors)
    {
        ...
        var model = new TransferLearning.GraphBuilder( pretrained ).fineTuneConfiguration( fineTuneConf )
                .removeVertexKeepConnections( "conv2d_9" )
                .removeVertexKeepConnections( "outputs" )
                .addLayer( "convolution2d_9", new ConvolutionLayer.Builder( 1, 1 ).nIn( 1024 )
