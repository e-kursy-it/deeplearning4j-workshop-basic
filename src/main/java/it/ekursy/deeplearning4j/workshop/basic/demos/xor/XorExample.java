package it.ekursy.deeplearning4j.workshop.basic.demos.xor;
...
public class XorExample {
    ...
    private static final Logger log = LogManager.getLogger( XorExample.class );
    ...
    public static void main(String[] args)
    {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder().updater( new Sgd( 0.1 ) )
                .seed( seed )
                ...
                .miniBatch( false )
                .list()
                .layer( new DenseLayer.Builder().nIn( 2 ).nOut( 4 ).activation( Activation.SIGMOID )
